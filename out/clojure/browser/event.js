...
goog.require('goog.events');
clojure.browser.event.EventType = (function (){var obj4962 = {};return obj4962;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__3550__auto__ = this$;if(and__3550__auto__)
...
{var x__4189__auto__ = (((this$ == null))?null:this$);return (function (){var or__3562__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__4189__auto__)]);if(or__3562__auto__)
{return or__3562__auto__;
} else
{var or__3562__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__3562__auto____$1)
...
return (function (p__4963){var vec__4964 = p__4963;var k = cljs.core.nth.call(null,vec__4964,0,null);var v = cljs.core.nth.call(null,vec__4964,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
...
return (function (p__4965){var vec__4966 = p__4965;var k = cljs.core.nth.call(null,vec__4966,0,null);var v = cljs.core.nth.call(null,vec__4966,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
